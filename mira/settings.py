...
with open(BASE_DIR / 'mira/VERSION') as f:
    VERSION = f.read().strip()
    print(f'MIRA Version: {VERSION}')

try:
    with open(BASE_DIR / 'mira/build.json') as f:
...
MIRA_URL = os.environ.get('MIRA_URL', 'http://127.0.0.1:8000')
...
MIRA_SUPERUSER_PASSWORD = os.environ.get('MIRA_SUPERUSER_PASSWORD')
